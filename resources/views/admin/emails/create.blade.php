<x-admin-layout>
    ...
    <div class="max-w-4xl mx-auto space-y-8">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-3xl font-bold text-slate-900">Novo Modelo</h1>
                <p class="text-slate-500 mt-1">Crie um novo modelo de e-mail para marketing.</p>
            </div>
        </div>

        <form action="{{ route('admin.emails.store') }}" method="POST" class="space-y-6">
            @csrf
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea name="content" rows="12"
                                    class="w-full bg-slate-50 border-slate-200 rounded-2xl focus:ring-primary/50 focus:border-primary transition-all font-medium py-4 px-6 border-2"
                                    placeholder="Você pode usar HTML e variáveis como {name}, {order_number}">{{ old('content') }}</textarea>
                    ...
                    <div class="bg-white rounded-3xl p-8 shadow-sm border border-slate-100 space-y-6">
                        ...
                        <div>
                            ...
                            <select name="type"
                                ...
                                <option value="system">Sistema (Auto-envio)</option>
                            </select>
                        </div>
                    </div>
